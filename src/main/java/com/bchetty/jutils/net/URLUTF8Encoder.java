 ...
 *
 * Copyright Â© 1997 World Wide Web Consortium, (Massachusetts Institute of
 * Technology, European Research Consortium for Informatics and Mathematics,
 * Keio University). All Rights Reserved. This work is distributed under the
 * W3CÂ® Software License [1] in the hope that it will be useful, but WITHOUT
...
public class URLUTF8Encoder {
     ...
     *
     * <ul>
     * <li><p>The ASCII characters 'a' through 'z', 'A' through 'Z', and '0'
     ...
     *
     * <li><p>All other ASCII characters are converted into the 3-character
     * string "%xy", where xy is the two-digit hexadecimal representation of the
     * character code
     *
